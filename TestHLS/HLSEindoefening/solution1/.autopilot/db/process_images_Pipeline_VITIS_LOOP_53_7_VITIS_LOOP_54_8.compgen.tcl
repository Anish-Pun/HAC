...
set name process_images_mul_32ns_34ns_65_3_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


set name process_images_urem_32ns_3ns_2_36_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename max_result \
    op interface \
    ports { max_result_address0 { O 14 vector } max_result_ce0 { O 1 bit } max_result_we0 { O 1 bit } max_result_d0 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename min_result \
    op interface \
    ports { min_result_address0 { O 14 vector } min_result_ce0 { O 1 bit } min_result_we0 { O 1 bit } min_result_d0 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename avg_result \
    op interface \
    ports { avg_result_address0 { O 14 vector } avg_result_ce0 { O 1 bit } avg_result_we0 { O 1 bit } avg_result_d0 { O 8 vector } } \
} "
} else {
