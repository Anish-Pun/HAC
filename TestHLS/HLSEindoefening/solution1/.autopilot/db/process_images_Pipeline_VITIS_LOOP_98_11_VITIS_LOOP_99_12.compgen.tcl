...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename max_result \
    op interface \
    ports { max_result_address0 { O 14 vector } max_result_ce0 { O 1 bit } max_result_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename min_result \
    op interface \
    ports { min_result_address0 { O 14 vector } min_result_ce0 { O 1 bit } min_result_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename avg_result \
    op interface \
    ports { avg_result_address0 { O 14 vector } avg_result_ce0 { O 1 bit } avg_result_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { max_out_TREADY { I 1 bit } max_out_TDATA { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { max_out_TVALID { O 1 bit } max_out_TDEST { O 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { min_out_TREADY { I 1 bit } min_out_TDATA { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { min_out_TVALID { O 1 bit } min_out_TDEST { O 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { avg_out_TREADY { I 1 bit } avg_out_TDATA { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { avg_out_TVALID { O 1 bit } avg_out_TDEST { O 1 vector } } \
} "
} else {
