...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { conv_result_address0 { O 16 vector } conv_result_ce0 { O 1 bit } conv_result_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { conv_out_TREADY { I 1 bit } conv_out_TDATA { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { conv_out_TVALID { O 1 bit } conv_out_TDEST { O 1 vector } } \
} "
} else {
