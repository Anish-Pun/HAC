...
HLS_SOURCES = ../../../hls_process_images_tb.cpp ../../../hls_process_images.cpp
...
$(ObjDir)/hls_process_images_tb.o: ../../../hls_process_images_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../hls_process_images_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/hls_process_images_tb.d

$(ObjDir)/hls_process_images.o: ../../../hls_process_images.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../hls_process_images.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/hls_process_images.d
