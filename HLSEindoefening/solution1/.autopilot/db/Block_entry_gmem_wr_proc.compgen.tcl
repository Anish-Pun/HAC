...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { conv_result_address0 { O 22 vector } conv_result_ce0 { O 1 bit } conv_result_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename max_result \
    op interface \
    ports { max_result_address0 { O 20 vector } max_result_ce0 { O 1 bit } max_result_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'max_result'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename min_result \
    op interface \
    ports { min_result_address0 { O 20 vector } min_result_ce0 { O 1 bit } min_result_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'min_result'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename avg_result \
    op interface \
    ports { avg_result_address0 { O 20 vector } avg_result_ce0 { O 1 bit } avg_result_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'avg_result'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { conv_output_dout { I 64 vector } conv_output_empty_n { I 1 bit } conv_output_read { O 1 bit } conv_output_num_data_valid { I 3 vector } conv_output_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_max_output \
    op interface \
    ports { max_output_dout { I 64 vector } max_output_empty_n { I 1 bit } max_output_read { O 1 bit } max_output_num_data_valid { I 3 vector } max_output_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_min_output \
    op interface \
    ports { min_output_dout { I 64 vector } min_output_empty_n { I 1 bit } min_output_read { O 1 bit } min_output_num_data_valid { I 3 vector } min_output_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_avg_output \
    op interface \
    ports { avg_output_dout { I 64 vector } avg_output_empty_n { I 1 bit } avg_output_read { O 1 bit } avg_output_num_data_valid { I 3 vector } avg_output_fifo_cap { I 3 vector } } \
} "
}
