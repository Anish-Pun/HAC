...
HLS_SOURCES = ../../../../Include/Pollings_TB.c ../../../../Include/Pollings.c
...
$(ObjDir)/Pollings_TB.o: ../../../../Include/Pollings_TB.c $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../Include/Pollings_TB.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -std=gnu99 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/Pollings_TB.d

$(ObjDir)/Pollings.o: ../../../../Include/Pollings.c $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../Include/Pollings.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -std=gnu99 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/Pollings.d
