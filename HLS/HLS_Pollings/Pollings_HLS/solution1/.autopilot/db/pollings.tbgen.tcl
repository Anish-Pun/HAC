...
set C_modelName {pollings}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem int 8 regular {axi_master 2}  }
	{ in_img int 64 regular {axi_slave 0}  }
	{ max_pool int 64 regular {axi_slave 0}  }
	{ min_pool int 64 regular {axi_slave 0}  }
	{ avg_pool int 64 regular {axi_slave 0}  }
}
set hasAXIMCache 0
set hasAXIML2Cache 0
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "in_img","offset": { "type": "dynamic","port_name": "in_img","bundle": "control_r"},"direction": "READONLY"},{"cName": "max_pool","offset": { "type": "dynamic","port_name": "max_pool","bundle": "control_r"},"direction": "WRITEONLY"},{"cName": "min_pool","offset": { "type": "dynamic","port_name": "min_pool","bundle": "control_r"},"direction": "WRITEONLY"},{"cName": "avg_pool","offset": { "type": "dynamic","port_name": "avg_pool","bundle": "control_r"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "max_pool", "interface" : "axi_slave", "bundle":"control_r","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":28}, "offset_end" : {"in":39}} , 
 	{ "Name" : "min_pool", "interface" : "axi_slave", "bundle":"control_r","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":40}, "offset_end" : {"in":51}} , 
 	{ "Name" : "avg_pool", "interface" : "axi_slave", "bundle":"control_r","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":52}, "offset_end" : {"in":63}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"pollings","role":"start","value":"0","valid_bit":"0"},{"name":"pollings","role":"continue","value":"0","valid_bit":"4"},{"name":"pollings","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"pollings","role":"start","value":"0","valid_bit":"0"},{"name":"pollings","role":"done","value":"0","valid_bit":"1"},{"name":"pollings","role":"idle","value":"0","valid_bit":"2"},{"name":"pollings","role":"ready","value":"0","valid_bit":"3"},{"name":"pollings","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "s_axi_control_r_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control_r", "role": "AWADDR" },"address":[{"name":"in_img","role":"data","value":"16"},{"name":"max_pool","role":"data","value":"28"},{"name":"min_pool","role":"data","value":"40"},{"name":"avg_pool","role":"data","value":"52"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"Port" : [
			...
			{"Name" : "min_pool", "Type" : "None", "Direction" : "I"},
			{"Name" : "avg_pool", "Type" : "None", "Direction" : "I"}],
		"Loop" : [
...
set ArgLastReadFirstWriteLatency {
	pollings {
		gmem {Type IO LastRead 18 FirstWrite 15}
		in_img {Type I LastRead 0 FirstWrite -1}
		max_pool {Type I LastRead 0 FirstWrite -1}
		min_pool {Type I LastRead 0 FirstWrite -1}
		avg_pool {Type I LastRead 0 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4116", "Max" : "4116"}
	, {"Name" : "Interval", "Min" : "4117", "Max" : "4117"}
]}
