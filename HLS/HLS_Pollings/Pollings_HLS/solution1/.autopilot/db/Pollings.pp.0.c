...
__attribute__((sdx_kernel("pollings", 0))) void pollings(uint8_t in_img[64][64],
              ...
              uint8_t min_pool[32][32],
              uint8_t avg_pool[32][32]) {
#line 29 "C:/Github/HLS_Pollings/Pollings_HLS/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=pollings
# 11 "Include/Pollings.c"
...
#pragma HLS INTERFACE s_axilite port=return bundle=control
 ...
 VITIS_LOOP_20_1: for (int i = 0; i < 32; i++) {
        VITIS_LOOP_21_2: for (int j = 0; j < 32; j++) {
#pragma HLS PIPELINE II=1
 uint8_t max_val = 0;
            uint8_t min_val = 255;
            uint16_t sum = 0;

            VITIS_LOOP_27_3: for (int ki = 0; ki < 2; ki++) {
                VITIS_LOOP_28_4: for (int kj = 0; kj < 2; kj++) {
