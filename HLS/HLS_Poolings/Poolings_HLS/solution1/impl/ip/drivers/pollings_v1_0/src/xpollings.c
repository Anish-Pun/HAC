...
void XPollings_Set_in_img(XPollings *InstancePtr, u64 Data) {
    ...
    XPollings_WriteReg(InstancePtr->Control_BaseAddress, XPOLLINGS_CONTROL_ADDR_IN_IMG_DATA, (u32)(Data));
    XPollings_WriteReg(InstancePtr->Control_BaseAddress, XPOLLINGS_CONTROL_ADDR_IN_IMG_DATA + 4, (u32)(Data >> 32));
}
...
u64 XPollings_Get_in_img(XPollings *InstancePtr) {
    ...
    Data = XPollings_ReadReg(InstancePtr->Control_BaseAddress, XPOLLINGS_CONTROL_ADDR_IN_IMG_DATA);
    Data += (u64)XPollings_ReadReg(InstancePtr->Control_BaseAddress, XPOLLINGS_CONTROL_ADDR_IN_IMG_DATA + 4) << 32;
    return Data;
}
...
void XPollings_Set_max_pool(XPollings *InstancePtr, u64 Data) {
    ...
    XPollings_WriteReg(InstancePtr->Control_BaseAddress, XPOLLINGS_CONTROL_ADDR_MAX_POOL_DATA, (u32)(Data));
    XPollings_WriteReg(InstancePtr->Control_BaseAddress, XPOLLINGS_CONTROL_ADDR_MAX_POOL_DATA + 4, (u32)(Data >> 32));
}
...
u64 XPollings_Get_max_pool(XPollings *InstancePtr) {
    ...
    Data = XPollings_ReadReg(InstancePtr->Control_BaseAddress, XPOLLINGS_CONTROL_ADDR_MAX_POOL_DATA);
    Data += (u64)XPollings_ReadReg(InstancePtr->Control_BaseAddress, XPOLLINGS_CONTROL_ADDR_MAX_POOL_DATA + 4) << 32;
    return Data;
}
...
void XPollings_Set_min_pool(XPollings *InstancePtr, u64 Data) {
    ...
    XPollings_WriteReg(InstancePtr->Control_BaseAddress, XPOLLINGS_CONTROL_ADDR_MIN_POOL_DATA, (u32)(Data));
    XPollings_WriteReg(InstancePtr->Control_BaseAddress, XPOLLINGS_CONTROL_ADDR_MIN_POOL_DATA + 4, (u32)(Data >> 32));
}
...
u64 XPollings_Get_min_pool(XPollings *InstancePtr) {
    ...
    Data = XPollings_ReadReg(InstancePtr->Control_BaseAddress, XPOLLINGS_CONTROL_ADDR_MIN_POOL_DATA);
    Data += (u64)XPollings_ReadReg(InstancePtr->Control_BaseAddress, XPOLLINGS_CONTROL_ADDR_MIN_POOL_DATA + 4) << 32;
    return Data;
}
...
void XPollings_Set_avg_pool(XPollings *InstancePtr, u64 Data) {
    ...
    XPollings_WriteReg(InstancePtr->Control_BaseAddress, XPOLLINGS_CONTROL_ADDR_AVG_POOL_DATA, (u32)(Data));
    XPollings_WriteReg(InstancePtr->Control_BaseAddress, XPOLLINGS_CONTROL_ADDR_AVG_POOL_DATA + 4, (u32)(Data >> 32));
}
...
u64 XPollings_Get_avg_pool(XPollings *InstancePtr) {
    ...
    Data = XPollings_ReadReg(InstancePtr->Control_BaseAddress, XPOLLINGS_CONTROL_ADDR_AVG_POOL_DATA);
    Data += (u64)XPollings_ReadReg(InstancePtr->Control_BaseAddress, XPOLLINGS_CONTROL_ADDR_AVG_POOL_DATA + 4) << 32;
    return Data;
}
