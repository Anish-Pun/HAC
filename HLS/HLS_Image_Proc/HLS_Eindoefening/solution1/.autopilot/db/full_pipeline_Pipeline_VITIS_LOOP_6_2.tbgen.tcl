set moduleName full_pipeline_Pipeline_VITIS_LOOP_6_2
set isTopModule 0
...
set C_modelName {full_pipeline_Pipeline_VITIS_LOOP_6_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem int 32 regular {axi_master 2}  }
	{ sub2_i int 31 regular  }
	{ sext_ln6 int 62 regular  }
	{ zext_ln5_2 int 45 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "input_r","offset": { "type": "dynamic","port_name": "input_r","bundle": "control"},"direction": "READONLY"},{"cName": "kernel","offset": { "type": "dynamic","port_name": "kernel","bundle": "control"},"direction": "READONLY"},{"cName": "conv_out","offset": { "type": "dynamic","port_name": "conv_out","bundle": "control"},"direction": "WRITEONLY"},{"cName": "max_out","offset": { "type": "dynamic","port_name": "max_out","bundle": "control"},"direction": "WRITEONLY"},{"cName": "min_out","offset": { "type": "dynamic","port_name": "min_out","bundle": "control"},"direction": "WRITEONLY"},{"cName": "avg_out","offset": { "type": "dynamic","port_name": "avg_out","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sub2_i", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln6", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln5_2", "interface" : "wire", "bitwidth" : 45, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sub2_i sc_in sc_lv 31 signal 1 } 
	{ sext_ln6 sc_in sc_lv 62 signal 2 } 
	{ zext_ln5_2 sc_in sc_lv 45 signal 3 } 
	{ input_r sc_in sc_lv 64 signal 4 } 
	{ gmem_addr_read_2 sc_in sc_lv 32 signal 5 } 
	{ gmem_addr_read_5 sc_in sc_lv 32 signal 6 } 
	{ gmem_addr_read_1 sc_in sc_lv 32 signal 7 } 
	{ gmem_addr_read_8 sc_in sc_lv 32 signal 8 } 
	{ gmem_addr_read sc_in sc_lv 32 signal 9 } 
	{ gmem_addr_read_6 sc_in sc_lv 32 signal 10 } 
	{ gmem_addr_read_4 sc_in sc_lv 32 signal 11 } 
	{ gmem_addr_read_3 sc_in sc_lv 32 signal 12 } 
	{ gmem_addr_read_7 sc_in sc_lv 32 signal 13 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub2_i", "direction": "in", "datatype": "sc_lv", "bitwidth":31, "type": "signal", "bundle":{"name": "sub2_i", "role": "default" }} , 
 	{ "name": "sext_ln6", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln6", "role": "default" }} , 
 	{ "name": "zext_ln5_2", "direction": "in", "datatype": "sc_lv", "bitwidth":45, "type": "signal", "bundle":{"name": "zext_ln5_2", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "25", "Max" : "-1"}
	, {"Name" : "Interval", "Min" : "25", "Max" : "-1"}
]}
...
set Spec2ImplPortList { 
	...
	sub2_i { ap_none {  { sub2_i in_data 0 31 } } }
	sext_ln6 { ap_none {  { sext_ln6 in_data 0 62 } } }
	zext_ln5_2 { ap_none {  { zext_ln5_2 in_data 0 45 } } }
