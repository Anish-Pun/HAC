...
set name full_pipeline_mul_32s_32s_32_2_1
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln6 \
    op interface \
    ports { sext_ln6 { I 62 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_zext_ln5_2 \
    op interface \
    ports { zext_ln5_2 { I 45 vector } } \
} "
}
...
set InstName full_pipeline_flow_control_loop_pipe_sequential_init_U
set CompName full_pipeline_flow_control_loop_pipe_sequential_init
