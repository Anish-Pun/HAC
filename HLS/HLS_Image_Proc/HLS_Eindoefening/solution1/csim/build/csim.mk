...
HLS_SOURCES = ../../../../Include/HLS_TB.c ../../../../Include/HLS.c
...
$(ObjDir)/HLS_TB.o: ../../../../Include/HLS_TB.c $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../Include/HLS_TB.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -std=gnu99 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/HLS_TB.d

$(ObjDir)/HLS.o: ../../../../Include/HLS.c $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../Include/HLS.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -std=gnu99 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/HLS.d
