...
HD_PWD='C:/HAC/HLS_Image_Proc/vivado/HLS_IMG.runs/design_1_full_pipeline_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_full_pipeline_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_full_pipeline_0_1.tcl
