...
HLS_SOURCES = ../../../../Include/Convolution_TB.c ../../../../Include/Convolution.c
...
$(ObjDir)/Convolution_TB.o: ../../../../Include/Convolution_TB.c $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../Include/Convolution_TB.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -std=gnu99 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/Convolution_TB.d

$(ObjDir)/Convolution.o: ../../../../Include/Convolution.c $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../Include/Convolution.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
