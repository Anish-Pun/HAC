...
HLS_SOURCES = ../../../hls_process_images_tb.c ../../../hls_process_images.c
...
$(ObjDir)/hls_process_images_tb.o: ../../../hls_process_images_tb.c $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../hls_process_images_tb.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
...
$(ObjDir)/hls_process_images.o: ../../../hls_process_images.c $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../hls_process_images.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
